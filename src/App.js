...
class App extends React.Component{
  state={
    articles:[
      ...
      {id:1, title:`article 2`, body:`this is article 2`, active:0},
      {id:1, title:`article 3`, body:`this is article 3`, active:1},
    ],
    loading:false,
    mouseHover:false
  ...
  loadMore(e){
    ...
    render(){
      ...
      let articleList= this.state.articles.map((item,index)=> item.active ? <Card key={index} title={item.title} body={item.body} /> : null);
      const btnStyle={
        backgroundColor:'#555', 
        padding:'10px 15px', 
        color:'white', 
